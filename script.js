...
function renderCart() {
  ...
  if (cartItems.length === 0) {
    ...
    cartTotalPrice.textContent = "Total: 0 KZT";
    return;
  }
    ...
    cartItem.innerHTML = `
      <div class="flex-for" style="display:flex;align-items:center;justify-content:space-between;width:100%;">
          <div class="flex-for-2" style="display:flex;align-items:center;gap:20px;">
              <div class="fon" style="width:80px;height:70px;overflow:hidden;border-radius:17px; background-color:#ffffff;display:flex;align-items:center;justify-content:center; border:1px solid #DEDEDE;">
                  <img src="${
                    item.image
  ...
  cartTotalPrice.textContent = `Total: ${total} KZT`;
}
